#' Terkos Dam Data
#'
#' Terkos Dam is one of the largest dams supplying Istanbul, Türkiye, and is located on the European side.
...
#' \url{https://data.ibb.gov.tr/en/dataset/istanbul-barajlari-gunluk-doluluk-oranlari/resource/af0b3902-cfd9-4096-85f7-e2c3017e4f21}.
#' 
...
#' resulting in a total of 95 observations.
#' 
#' @name TerkosDam
#' @docType data
#' @usage TerkosDam
